...
issue](https://github.com/cisagov/Ready-Set-Cyber/issues) in this
...
request](https://github.com/cisagov/Ready-Set-Cyber/pulls), you will
...
```console
cd Ready-Set-Cyber
pyenv virtualenv <python_version_to_use> Ready-Set-Cyber
pyenv local Ready-Set-Cyber
